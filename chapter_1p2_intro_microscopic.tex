...
XUV can be used to describe soft \optprefixp{X}{rays}~\cite{Eichmeier2008,iso21348}
...
To access core electrons, photons must be highly energetic, as usually found in \xrays.
...
the barrier suppression in single photon absorption which is shown in figure
