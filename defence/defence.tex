...
\column{0.6\textwidth}
    \begin{itemize}
    \item<+-> Model for intense \& short-$\lambda$ laser interaction
    \item<+-> Rare gas clusters; versatile tool \& stepping stone
    \item<+-> Complete simulation package
        \begin{itemize}
        \item Molecular dynamics (MD)
        \item Ionization library
        \item Other supporting libraries
        \item GPU accelerated (OpenCL)
        \end{itemize}
    \item<.-> Available on group's Gitlab:\\%
        {\begin{tiny}\color{blue}\url{https://gitlab.cphoton.science.uottawa.ca/nbigaouette}\end{tiny}}
    \end{itemize}

\column{0.5\textwidth}
    \begin{itemize}
     \item<+-> Quantum solver: first step
     \item<+-> Model can reproduce many experimental results
     \item<.-> Lead to publications
    \end{itemize}
