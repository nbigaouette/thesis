...
\begin{textblock}{0.48}(0.515,0.27)
    \only<2>{     \includegraphics[width=\textwidth]{figures/cs_evolution_wo_aci} }
\end{textblock}
\begin{textblock}{0.48}(0.515,0.27)
    \only<3>{     \includegraphics[width=\textwidth]{figures/cs_evolution_wo_and_w_aci} }
\end{textblock}
\begin{textblock}{0.48}(0.515,0.27)
    \only<4>{     \includegraphics[width=\textwidth]{figures/cs_evolution_wo_and_w_aci_es} }
\end{textblock}
...
\begin{textblock}{0.48}(0.515,0.30)
    \only<5->{\includegraphics[width=\textwidth]{figures/ionization_relative}}
\end{textblock}
...
\column{0.5\textwidth}
    ...
    \item<.-> QFDTD:
        \begin{itemize}
        \item<.-> Self-consistent potential?
...
% ---------------------------------------------------------------
\subsection{Lifetime of excited states}
% ***************************************************************
\begin{frame}{}\framenumber
\begin{center}
