   ...
   \begin{columns}
       ...
       \column{0.5\textwidth}
        ...
        \begin{center}
            ...
            %\color{white}\only<1>{\includegraphics[draft,width=0.7\textwidth]{../figures/auger_step_1}}\color{black}
...
% ---------------------------------------------------------------
\subsection{Real time vs Imaginary time}
% ***************************************************************
\begin{frame}{}\framenumber
   \begin{columns}[t]
   ...
   Real time:
       \begin{itemize}
           ...
           \item FT of time evolution $\rightarrow$ eigenvalues
           \item Running FT gives eigenstates
           \item Use whole domain for spectrum: all states!
       \end{itemize}
   ...
   Imaginary time:
       \begin{itemize}
           \item Wick rotation of $\pi$/2 in complex plane
           \item $\psi\pa{\vecr,\tau}=\sum_{n}\e{-E_n \tau}c_n\phi_n\pa{\vecr}$
           \item Eigenstates \& Eigenvalues directly
...
\begin{flushright}
\includegraphics[width=0.75\textwidth]{figures/h2p_spectrum}
\end{flushright}
\end{frame}
...
\begin{frame}{Imaginary time}\framenumber\setbeamercovered{invisible}
   \begin{columns}[t]
    \column{0.5\textwidth}
        \begin{center}
        H \\
        \includegraphics[width=\textwidth]{figures/h_eigenstates}
    ...
    \uncover<2->{
        \begin{center}
        H$_{2}^{+}$ \\
        \includegraphics[width=\textwidth]{figures/h2p_eigenstates}\\
        {
        \begin{tiny}
