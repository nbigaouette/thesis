...
electrons (keV) or highly charged ion (MeV) emission, X-ray production or even
...
reactions and so do not interact much with each other. Rare-gas clusters are
...
have a better scaling than MD in terms of particle number, and since they treat
...
do (soft) X-ray diffraction imaging using FLASH pulses\cite{Chapman2006}:
...
this hard X-ray source\cite{Young2010} showing fully stripped neon nucleus.
