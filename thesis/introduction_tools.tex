...
\item WARNING: Don't go into too much details. I don't want to get questions on
stuff I don't know or haven't used.
\end{itemize}
...
simple to implement and use, give macroscopic properties easily and allows a
relatively large amount of particles to be simulated, while still allowing
specific quantum treatment when necessary (for example for ionization). For
...
are made for use in the current work. For example, they often assume an
infinite bulk.
