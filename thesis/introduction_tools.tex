...
\begin{itemize}
\item \fxnote{Insist that everything in that section is my own work. It's not me citing
other people's work.}
\item \fxnote{Description of how we implemented the model.}
\item \fxwarning{Don't go into too much details. I don't want to get questions on
