...
\fxnote{Make sure to state for QFDTD: It's a one electron picture}\\
\fxnote{Make sure to state for QFDTD: Main goal is to get a better picture of
        the environment influence on different states}\\
\fxfatal{Add a paragraph or two on mapping as it is NEW.}
