...
wavelength -- Vacuum Ultra-Violet (VUV), Extreme Ultra-Violet (XUV), soft
X-Rays, etc. -- still is a relatively unexplored field.
...
used. Note that all implementation used are original work; all code packages
...
ionization''. Also published in 2011, Argon clusters were simulated in the XUV
regime and many cluster parameters were studied.
...
applied to the VUV regime and Xenon clusters, similar parameters as the 2002
