...
\subsubsection{Short wavelength: Into the VUV and XUV}
\label{section:intro:mechanisms:vuv}


\subsubsection{Ultra-short wavelength: X-rays}
\label{section:intro:mechanisms:xrays}
...
\subsection{Motivation: Microscopic mechanisms underlying the dynamics - OLD}
...
Due to the failed attempt at describing the experiments using direct mechanisms,
...
photon energy needs to be at least the binding energy of the electron. In the
case of atomic Xenon, the first energy level is at -12.3 eV (see table
\ref{tab:ips}) which requires a photon of a wavelength equal or shorter than
100.8 nm. These wavelengths are normally called \textit{vacuum ultra-violet}
(VUV) or \textit{extreme ultra-violet} (XUV).
...
\backslashbox{Levels}{Elements} & \mc{2}{|c|}{Argon} & \mc{2}{|c|}{Xenon} \\ \hline
  & Ip [eV] & $\lambda$ [nm]    & Ip [eV]   & $\lambda$ [nm] \\ \hline \hline
1 & 16.00   & 77.49             & 12.265625 & 101.1 \\ \hline
2 & 32.34   & 38.34             & 21.390625 & 57.96 \\ \hline
3 & 48.68   & 25.47             & 31.296875 & 39.62 \\ \hline
4 & 65.02   & 19.07             & 41.859375 & 29.62 \\ \hline
5 & 81.56   & 15.20             & 55.015625 & 22.54 \\ \hline
\end{tabular}
...
On one side tunnel ionization is dominant, the wavelength is large and
$\gamma \ll 1$, while single
