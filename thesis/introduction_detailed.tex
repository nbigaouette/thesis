...
\subsection{Motivation: Microscopic mechanisms underlying cluster dynamics}
...
of the interaction between particles with the laser field. They can normally be
...
\fxfatal[margin,noinline]{Describe recombination paper!!!}
