...
into consideration the electromagnetic field propagation throughout the cluster.
Going from electrostatic to electrodynamic allows simulating clusters of
significant size where fields propagation must be correctly resolved. The
