...
\fxfatal[noinline,margin]{Cite all papers sent by LR's (Krainov2007)}
...
the ion's Coulomb potential is bent so much that electrons can tunnel out.
However, when $\gamma \gg 1$ the laser frequency is too large compared to the
field's strength and photon processes dominates. Experiments in
...
\fxnote[noinline,margin]{Maybe check with Charles' paper for Mie freq. in Fennel2010's eq. (8)?}

\fxfatal{Add how IBH scales with frequency. Landau \& Lifshitz?
Couldn't find it... Cite Krainov2000\cite{Krainov2000} for a different IBH rate}
...
\begin{figure}
 \centering
    \begin{subfigure}{0.48\columnwidth}
        ...
        \caption{Step 1: An xenon inner shell electron (4d) absorb a high
...
atoms have a giant resonance of the 4d state; the cross-section of
photoionization of the (inner-shell) 4d electron is ten times larger than the
...
hydrodynamically. These results could be reproduced by our models in a recently
...
\fxfatal[noinline,margin]{WARNING: Make sure to use the proper wavelength/energy:
32.8 nm = 37.8 eV and 13.7 nm = 90.5 eV}
...
\fxfatal[noinline,margin]{Cite opensource packages somewere: matplotlib\cite{matplotlib}}
