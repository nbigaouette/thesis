...
From the different cross-sections, rates of event $\Gamma$ are calculated.
...
% with its kinetic energy set as the difference between the
...
\fxfatal[margin]{Impact cross sections from Cowan code or experimental data??}
...
\begin{figure}
    ...
    \end{center}
    \caption{\label{fig:recombination}Recombination energy diagram\fxfatal{Move to Vb section?}}
\end{figure}
