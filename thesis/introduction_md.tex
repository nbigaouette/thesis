...
generated using
PyMOL\footnote{\textit{The PyMOL Molecular Graphics System}, Version 1.5.0.4, Schrödinger, LLC. \url{http://pymol.org/}}
...
\begin{figure}
 ...
 \caption{\label{fig:potential:heating:depth}Energy variation after single photon
          ...
          \fxfatal{Remove the blue curve as it seems there is two!}}
\end{figure}
