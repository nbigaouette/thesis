...
\begin{figure}
 ...
 \fxwarning[noinline,margin]{Create real figure: Vectors definition}
...
\begin{figure}
 ...
 \fxwarning[noinline,margin]{Create real figure: Quadtree}
\end{figure}
...
\begin{figure}
 ...
 \label{fig:tree:mac}
 \fxwarning[noinline,margin]{Create real figure: Tree MAC}
\end{figure}
...
\includegraphics[width=0.98\columnwidth]{figures/potential_shapes}
    ...
    40.8 eV.}
 \fxwarning[noinline,margin]{Harmonise figure with others \& Use same latex code}
\end{figure}
...
\begin{figure}
 \centering
 \includegraphics[width=0.95\columnwidth]{figures/numerical_heating_dt}
...
\begin{figure}
 \centering
 \includegraphics[width=0.95\columnwidth]{figures/numerical_heating_D}
...
\fxnote[noinline,margin]{Add to the conclusion; test Vb using QFDTD}
