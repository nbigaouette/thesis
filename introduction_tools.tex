...
% few workds about the quantum monte carlo method, and a citation?
...
%simple 
straightforward
% (dont' want to make the bulk of the thesis sound "simple" :)
...
%
% for the below, want to emphasize that microscopic pic is a NEW method, rather than the estabilished methods you describe above. and you could say that it is an interesting future direction, or something like that.
PIC
...
% add citation for MD method. might also mention that there are refinements on md, like treecode, and also
% the limitation that it cannot account for field propagation effects, like the microscopic pic can.
...
%It is hartree-fock, isn't it? just want to verify
