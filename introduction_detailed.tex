...
\fxfatal[author=LR]{nic, did we ever talk about the downsides of the rost model?}
...
\fxfatal[author=LR]{akward, please reword...}
...
\fxfatal[author=LR]{we didn't "decide" to not use a quantum picture, we "couldn't". please reword.}

\fxfatal[author=LR]{also remind me to talk to you about justifications of classical
...
\fxfatal[author=LR]{if we add the recomb paper, do we have to change or add to the above?}
...
\fxfatal[author=LR]{your contributions to this paper.}
...
\fxfatal[author=LR]{put 100nm paper here}
