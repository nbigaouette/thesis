...
\fxfatal[author=LR]{I made the change to the last sentence, but
...
\cite{Lewenstein2008}.
\fxfatal[noinline,margin,author=LR]{you should be prepared to answer "why only odd harmonics?"}
...
\fxnote[author=LR,noinline,margin]{relate this to the "excursion" length, which is related to quiver energy, and the cluster size to give an intuitive picture of why.}
...
\fxfatal[noinline,margin,author=LR]{which collision frquency?}
...
\fxfatal[author=LR,noinline,margin]{xuv is a different regime from vuv. to
clarify, give the expected ranges for both regimes from a reliable source}
