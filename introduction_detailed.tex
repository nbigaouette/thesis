...
\fxnote[noinline,margin,author=LR]{any citations you can add to the above?}
...
\fxnote[author=LR]{make reference to attosecond science, rare gas atoms, and provide a reference to a book or review article - I moved the paragraph below to this spot. you'll have to clean it up a bit, with regards to the definition of "infrared":}
