...
\fxfatal[author=LR,noinline,margin]{there is also the above-threshold ionization
...
\fxfatal[author=LR]{i think this description of auger is good enough to include
the other paper. then just remove the citation to the paper from ehre.}
