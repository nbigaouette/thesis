...
laser.
\lrnote[margin,noinline]{This is not necessarily true. you can say they can affect energy absorption and/or charge state spectra}
...
\lrfatal{I made the change to the last sentence, but
...
\cite{Lewenstein2008}.
\lrfatal[noinline,margin]{you should be prepared to answer "why only odd harmonics?"}
...
\lrnote[noinline,margin]{relate this to the "excursion" length, which is related to quiver energy, and the cluster size to give an intuitive picture of why.}
...
\lrfatal[noinline,margin]{which collision frquency?}
...
\lrfatal[noinline,margin]{xuv is a different regime from vuv. to
...
\lrfatal{i think this description of auger is good enough to include
...
\lrfatal{we didn't "decide" to not use a quantum picture, we "couldn't". please reword.}
...
\lrfatal{if we add the recomb paper, do we have to change or add to the above?}
