...
The amplitude of the electron's quiver is the laser field is given by
\begin{align}
% Georgescu2007a, page 3
x_q & = \frac{F}{\omega^2}
\end{align}
where $F$ is the force of the laser field and $\omega$ its angular frequency. For
large frequencies, the quiver amplitude is small; the electric field oscillates
