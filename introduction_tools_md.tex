...
\lrfatal{you might also want to mention that we use some calculated and some
...
\lrfatal[noinline,margin]{Nic: verify this is true - I think 'ionization
potential' is very unclear here.}
recombination is forced: the electron disappears from the simulation and the ion
charge state is increased by one.

\lrfatal{Revise the below to include the recomb paper:}
