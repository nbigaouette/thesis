...
\documentclass[author={\Author},title={\Title},degree={Ph.D.},final]{uottawa}
...
\usepackage[status=final,inline,nomargin,multiuser,author=\AuthorInitials]{fixme}
...
\include{chapter_4_paper_2_size}
\include{chapter_5_paper_3_100nm}
\include{chapter_6_paper_4_recomb}
\include{chapter_7_paper_5_mapping}

% \include{other}

\include{chapter_8_discussion}
